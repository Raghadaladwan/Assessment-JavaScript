...
=> "You got 100 JD from sales, you should pay 15 JD for tax and you will
 have 85 JD as net sales."
*/
...
function calculateTax(num, amount) {
  ...
  total= num-sum;
    ...
    return "You got "+num+" JD from sales, you should pay "+sum+" JD for tax and you will have "+total+" JD as net sales.";
}
...
function stringToCapital(str) {
  ...
  if( str.length>=0)
  {
  	...
  	str.split(1);
    final= str.toUpperCase();+stringToCapital(str.length-1)
